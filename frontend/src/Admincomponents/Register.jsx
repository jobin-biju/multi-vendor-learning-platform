...
const Register = () => {
  ...
  const handleUserRegister = () =>{
    ...
    fetch('http://localhost:4000/multivendor/userRegister',{
      method:'POST',
      headers:{
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        // border: '1px solid rgba(209, 250, 246, 0.5)',
        marginRight: '100px'
      }}>
        <Link to={'/'} style={{
          display: 'flex',
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <input
              ...
              style={{
                width: '100%',
                padding: '12px 16px',
                border: errors.fullName ? '2px solid #d32f2f' : '2px solid #e5e7eb',
                borderRadius: '8px',
                fontSize: '15px',
                outline: 'none',
          ...
          <button
            ...
            onMouseOver={(e) => {
              if (!isSubmitting) {
                ...
                e.currentTarget.style.boxShadow = '0 6px 16px rgba(47, 191, 167, 0.3)';
              }
            }}
            onMouseOut={(e) => {
              if (!isSubmitting) {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 4px 12px rgba(47, 191, 167, 0.25)';
              }
            }}
          >
